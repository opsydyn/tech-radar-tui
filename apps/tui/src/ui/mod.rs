...
pub fn ui(app: &App, f: &mut Frame<'_>) {
    match app.screen {
        ...
        AppScreen::AdrActions => screens::adr_actions::render_adr_actions(app, f),
        AppScreen::AdrDetails => screens::adr_details::render_adr_details(app, f),
        AppScreen::EditAdr => screens::edit_adr::render_edit_adr(app, f),
